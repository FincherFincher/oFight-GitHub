...
*/
    ...
    class Template {
        ...
        function load_template($tpl_name) {
            ...
            $tpl_name = $this->totranslit($tpl_name['basename']);
        ...
        function load_file( $name, $include_file = "tpl" ) {
            global $db, $is_logged, $uinfo, $cat_info, $config, $user_group, $category_id, $_TIME, $lang, $smartphone_detected, $dle_module;
        ...
        function check_group($groups, $block, $action = true) {
            ...
            if( $action ) {
                ...
                if( ! in_array( $uinfo['uGroup'], $groups ) ) return "";
